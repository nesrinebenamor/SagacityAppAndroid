 ...
 */
public class AcceuilParseActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_quotes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AcceuilParseActivity.this,
                        ParseQuotesActivity.class);
        ...
        btn_authors.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent author = new Intent(AcceuilParseActivity.this,
        ...
        btn_favorites.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent favorites = new Intent(AcceuilParseActivity.this,
        ...
        btn_categories.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent category = new Intent(AcceuilParseActivity.this,
        ...
        btn_qteday.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent qteDay = new Intent(AcceuilParseActivity.this,
                        QuoteActivity.class);
                qteDay.putExtra("id",
