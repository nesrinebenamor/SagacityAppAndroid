...
import com.esprit.sagacity.activities.QuoteActivity;
...
public class NotifyService extends Service {
    ...
    public static final String INTENT_NOTIFY = "com.esprit.sagacity.INTENT_NOTIFY";
   // private NotificationManager mNM;
    ...
    private void showNotification() {
        ...
        if(prefNotif.equals(true)){
            ...
            intent1.putExtra("mode", "QUOTE_OF_THE_DAY");
